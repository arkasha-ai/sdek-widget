import {
  register
} from "./chunk-5Y5QZLMY.js";
import {
  projectionFromProperties
} from "./chunk-GVRI4PVT.js";
import {
  Geolocation_default,
  Map_default,
  Overlay_default
} from "./chunk-ZUYNHSWV.js";
import {
  useOpenLayersEvents
} from "./chunk-26Z4K7W4.js";
import {
  Feature_default,
  View_default
} from "./chunk-4JMTDPMJ.js";
import "./chunk-ACQ5Z6L3.js";
import {
  registerWithAliases,
  usePropsAsObjectProperties
} from "./chunk-NQ4GG4PG.js";
import {
  Geometry_default
} from "./chunk-LBBHLP3X.js";
import "./chunk-THMSZLB2.js";
import {
  computed,
  createCommentVNode,
  createElementBlock,
...
import {
  Projection_default
} from "./chunk-ZTK4UUJH.js";
import "./chunk-V2BPWYKL.js";
import "./chunk-DC5AMYBS.js";

// node_modules/vue3-openlayers/dist/esm/OlFeature.vue_vue_type_script_setup_true_lang-BQ_Uo_A7.js
var _sfc_main = defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const feature = ref(
      new Feature_default({ ...props.properties })
    );
    watch(
      () => props.properties,
      // Needed as props.properties is optional
      (properties) => {
        if (properties instanceof Geometry_default) {
    ...
    watch(
      ...
      (newVal, oldVal) => {
        var _a, _b, _c;
        (_a = oldVal == null ? void 0 : oldVal.value) == null ? void 0 : _a.removeFeature(feature.value);
        (_b = newVal == null ? void 0 : newVal.value) == null ? void 0 : _b.addFeature(feature.value);
    ...
    onMounted(() => {
      ...
      if (animation == null ? void 0 : animation.value) {
        (_a = layer == null ? void 0 : layer.value) == null ? void 0 : _a.animateFeature(feature.value, animation.value);
      }
      nextTick(() => {
        var _a2;
        (_a2 = vectorSource == null ? void 0 : vectorSource.value) == null ? void 0 : _a2.addFeature(feature.value);
      });
    });
    onUnmounted(() => {
      var _a;
      (_a = vectorSource == null ? void 0 : vectorSource.value) == null ? void 0 : _a.removeFeature(feature.value);
    });
...
// node_modules/vue3-openlayers/dist/esm/OlGeoLocation.vue_vue_type_script_setup_true_lang-D4rasQBc.js
...
// node_modules/vue3-openlayers/dist/esm/helpers/properties.js
...
// node_modules/vue3-openlayers/dist/esm/OlMap.vue_vue_type_script_setup_true_lang-CDNuAZLN.js
...
// node_modules/vue3-openlayers/dist/esm/OlOverlay.vue_vue_type_script_setup_true_lang-C010d8t1.js
var _sfc_main4 = defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const properties = usePropsAsObjectProperties(props);
    const overlay = shallowRef(new Overlay_default(properties));
...
// node_modules/vue3-openlayers/dist/esm/OlProjectionRegister.vue_vue_type_script_setup_true_lang-Bmk_-azE.js
...
// node_modules/vue3-openlayers/dist/esm/OlView.vue_vue_type_script_setup_true_lang-BKRD00s5.js
...
// node_modules/vue3-openlayers/dist/esm/map/index.js
function install(app, options) {
  registerWithAliases(app, "OlFeature", _sfc_main);
  registerWithAliases(app, "OlGeoLocation", _sfc_main2);
  registerWithAliases(app, "OlMap", _sfc_main3);
  registerWithAliases(app, "OlOverlay", _sfc_main4);
  registerWithAliases(app, "OlProjectionRegister", _sfc_main5);
  registerWithAliases(app, "OlView", _sfc_main6);
  if (options) {
...
export {
  ...
  _sfc_main2 as OlGeoLocation,
  _sfc_main3 as OlMap,
  _sfc_main4 as OlOverlay,
  _sfc_main5 as OlProjectionRegister,
  _sfc_main6 as OlView,
  install as default,
  install
};
//# sourceMappingURL=vue3-openlayers_map.js.map
