...
function requireDomToImageMore_min() {
  ...
  (function(module2, exports2) {
    ((l) => {
      ...
      } } }, m = (module2.exports = d, ("undefined" != typeof Node ? Node.ELEMENT_NODE : void 0) || 1), h = (void 0 !== l ? l.getComputedStyle : void 0) || ("undefined" != typeof window ? window.getComputedStyle : void 0) || globalThis.getComputedStyle, s = (void 0 !== l ? l.atob : void 0) || ("undefined" != typeof window ? window.atob : void 0) || globalThis.atob;
      function u(t2, r2) {
        d.impl.util.getWindow(t2);
        let i2 = (r2 = r2 || {}, d.impl.copyOptions(r2), []);
        return Promise.resolve(t2).then(function(e2) {
          if (e2.nodeType === m) return e2;
          var t3 = e2, n2 = e2.parentNode, o2 = document.createElement("span");
          return n2.replaceChild(o2, t3), o2.append(e2), i2.push({ parent: n2, child: t3, wrapper: o2 }), o2;
        }).then(function(e2) {
          return (function l2(t3, s2, i3, u2) {
            ...
            return Promise.resolve(t3).then(n2).then(o2).then(function(e4) {
              return c2(e4, a2(t3));
            ...
            function d2(u3, a3) {
              return !f.isElement(u3) || f.isShadowSlotElement(a3) ? Promise.resolve(u3) : Promise.resolve().then(t4).then(n3).then(o3).then(r4).then(e4).then(function() {
                return u3;
              });
              function e4() {
              ...
              function t4() {
                ...
                function e5(e6, t5) {
                  let n4 = h(e6);
                  n4.cssText ? (t5.style.cssText = n4.cssText, o4(n4, t5.style)) : (y(s2, e6, n4, i3, t5), null === i3 && (["inset-block", "inset-block-start", "inset-block-end"].forEach((e7) => t5.style.removeProperty(e7)), ["left", "right", "top", "bottom"].forEach((e7) => {
              ...
              function n3() {
                ...
                function t5(r5) {
                  ...
                  if ("" !== l3 && "none" !== l3) {
                    let n4 = function() {
                      let e6 = `.${s3}:` + r5, t7 = (i4.cssText ? n5 : o4)();
                      ...
                      function o4() {
                        ...
                        return e7 + ";";
                        function t8(e8) {
                          let t9 = i4.getPropertyValue(e8), n6 = i4.getPropertyPriority(e8) ? " !important" : "";
                          return e8 + ": " + t9 + n6;
                        }
                      }
                    };
          ...
          let n2 = r2.width || f.width(t2), o2 = r2.height || f.height(t2);
          return Promise.resolve(e2).then(function(e3) {
            ...
            var t3 = (f.isDimensionMissing(n2) ? ' width="100%"' : ` width="${n2}"`) + (f.isDimensionMissing(o2) ? ' height="100%"' : ` height="${o2}"`);
            return `<svg xmlns="http://www.w3.org/2000/svg"${(f.isDimensionMissing(n2) ? "" : ` width="${n2}"`) + (f.isDimensionMissing(o2) ? "" : ` height="${o2}"`)}><foreignObject${t3}>${e3}</foreignObject></svg>`;
          }).then(function(e3) {
...
const domtoimage = /* @__PURE__ */ _commonjsHelpers.getDefaultExportFromCjs(domToImageMore_minExports);
const _sfc_main = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return !srcImageUrl.value ? (vue.openBlock(), vue.createElementBlock("div", {
        key: 0,
        ref_key: "htmlContent",
        ref: htmlContent,
