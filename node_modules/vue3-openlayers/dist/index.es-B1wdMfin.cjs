...
const index$1 = require("./index-D-hPehid.cjs");
var es_promise = {};
...
function requireGlobalThis() {
  ...
  check(typeof self == "object" && self) || check(typeof index$1.commonjsGlobal == "object" && index$1.commonjsGlobal) || check(typeof globalThis_1 == "object" && globalThis_1) || // eslint-disable-next-line no-new-func -- fallback
  /* @__PURE__ */ (function() {
    return this;
...
function toPrimitive(t2, r2) {
  if ("object" != index$1._typeof(t2) || !t2) return t2;
  var e2 = t2[Symbol.toPrimitive];
  if (void 0 !== e2) {
    var i2 = e2.call(t2, r2);
    if ("object" != index$1._typeof(i2)) return i2;
...
function toPropertyKey(t2) {
  ...
  return "symbol" == index$1._typeof(i2) ? i2 : i2 + "";
}
...
function requireRaf() {
  ...
  hasRequiredRaf = 1;
  var now = requirePerformanceNow(), root = typeof window === "undefined" ? index$1.commonjsGlobal : window, vendors = ["moz", "webkit"], suffix = "AnimationFrame", raf$1 = root["request" + suffix], caf = root["cancel" + suffix] || root["cancelRequest" + suffix];
...
const requestAnimationFrame = /* @__PURE__ */ index$1.getDefaultExportFromCjs(rafExports);
var es_string_trim = {};
var whitespaces;
...
const RGBColor$1 = /* @__PURE__ */ index$1.getDefaultExportFromCjs(rgbcolorExports);
