...
declare const __VLS_component: DefineComponent<Props, {
    tileLayer: ShallowRef<TileLayer, TileLayer>;
    ...
    "change:useInterimTilesOnError": (event: ObjectEvent) => any;
    "change:preload": (event: ObjectEvent) => any;
    ...
    "onChange:useInterimTilesOnError"?: ((event: ObjectEvent) => any) | undefined;
    "onChange:preload"?: ((event: ObjectEvent) => any) | undefined;
