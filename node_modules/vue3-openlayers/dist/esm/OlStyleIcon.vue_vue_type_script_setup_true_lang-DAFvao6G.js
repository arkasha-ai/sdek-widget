import { defineComponent, useSlots, ref, inject, computed, watch, onMounted, onUnmounted, createElementBlock, createCommentVNode, openBlock, renderSlot } from "vue";
...
function requireDomToImageMore_min() {
  ...
  (function(module, exports) {
    ((l) => {
      ...
      } } }, m = (module.exports = d, ("undefined" != typeof Node ? Node.ELEMENT_NODE : void 0) || 1), h = (void 0 !== l ? l.getComputedStyle : void 0) || ("undefined" != typeof window ? window.getComputedStyle : void 0) || globalThis.getComputedStyle, s = (void 0 !== l ? l.atob : void 0) || ("undefined" != typeof window ? window.atob : void 0) || globalThis.atob;
      function u(t2, r2) {
