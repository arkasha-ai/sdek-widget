...
def _arc_to_beziers(x1,y1, rx,ry, phi_deg, fa,fs, x2,y2):
    ...
    for i in range(n_segs):
        ...
        dt = t2 - t1
        k = math.tan(dt/4)*4/3  # correct Bezier kappa for arc segment
...
LUCIDE_D = {
    ...
    "map-pin": [
        ...
        "M12,7 C13.6568542494,7 15,8.3431457506 15,10 C15,11.6568542494 13.6568542494,13 12,13 C10.3431457506,13 9,11.6568542494 9,10 C9,8.3431457506 10.3431457506,7 12,7Z",
    ],
    "flame": [
    ...
    "user": [
        ...
        "M12,3 C14.2091389992,3 16,4.7908610008 16,7 C16,9.2091389992 14.2091389992,11 12,11 C9.7908610008,11 8,9.2091389992 8,7 C8,4.7908610008 9.7908610008,3 12,3Z",
    ],
    "footprints": [
