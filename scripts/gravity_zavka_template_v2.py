#!/usr/bin/env python3
"""
Генератор ЗАЯВОК для Gravity Group (точная копия оригинала)
Использование: python3 gravity_zavka_template_v2.py
"""
...
def create_zavka_document(data):
    """
    Создание ТОЧНОЙ КОПИИ заявки Gravity Group
    """
...
if __name__ == "__main__":
    ...
    output_path = "/home/clawdbot/.openclaw/workspace/docs/gravity_zavka_FIXED.docx"
    doc.save(output_path)
    
    print(f"✅ Исправленный шаблон создан: {output_path}")
    print("\n📋 ИСПРАВЛЕНО:")
    print("  ✅ Убрано центрирование заголовков")
    print("  ✅ Размер шрифта 12pt везде")
    print("  ✅ Стиль таблиц: Normal Table")
    print("  ✅ Формат денег: 147 450 (пробел)")
    print("  ✅ Формат часов: 23,00 (запятая)")
    print("  ✅ Формат дат: «16» мая (с кавычками)")
