#!/usr/bin/env python3
"""
Точное воспроизведение Заявки №4 с ТЗ (ИСПРАВЛЕННАЯ ВЕРСИЯ)
"""
...
add_para("Предварительная стоимость работ по Заявке составляет 166 057 (Сто шестьдесят шесть тысяч пятьдесят семь) рублей, 50 копеек, в т.ч. НДС 5% - 7 907,50 рублей.", with_indent=True)
...
# === СОХРАНЕНИЕ ===
output_path = "/home/clawdbot/.openclaw/workspace/docs/zavka4_reproduced_FIXED.docx"
doc.save(output_path)

print(f"✅ ИСПРАВЛЕННЫЙ документ создан: {output_path}")
print("\n📋 ИСПРАВЛЕНО:")
print("  ✅ Добавлен заголовок 'Приложение №1' (RIGHT)")
print("  ✅ Добавлено 'к Заявке №4...' (RIGHT)")
print("  ✅ Добавлено 'по Договору №14/25...' (RIGHT)")
print("  ✅ Добавлен заголовок 'Техническое задание' (CENTER)")
print("  ✅ Теперь правильное количество параграфов")
