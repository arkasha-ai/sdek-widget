<template>
  <div class="sdwo-map-col">
    ...
    <!-- Кнопка скрытия/показа сайдбара (десктоп, top-right на карте) -->
    <button
      class="sdwo-map-close"
      :class="{ 'sdwo-map-close--collapsed': !panelOpen }"
...
const emit = defineEmits(['moveend', 'markerselect', 'mapclick', 'filterchange', 'togglepanel']);
